...
- Ownership: would they drive things with nobody watching? The month-four answer is the tell — do they act, prioritise and decide, or wait for the founder? On the first hire, they were told nothing about who we would pick, so the choice is entirely theirs — judge the REASONING: is the role they choose the one that would actually unblock this business, and do they have a sensible way to find and judge that person? (Q5, Q7)
